...
.then((client) => {
    ...
    const nationalAnimalsQuizCollection = db.collection('national-animals-quiz')
    const nationalAnimalsQuizResultsRouter = createRouter(nationalAnimalsQuizCollection)
    ...
    app.use('/api/countries/quiz-results/national-animals', nationalAnimalsQuizResultsRouter)
})
.catch(console.error)
